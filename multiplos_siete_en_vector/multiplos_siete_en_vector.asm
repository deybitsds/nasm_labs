...
;elemento múltiplo de 7, en una matriz de
; MxN. M, N y los elementos de la matriz deben
;ser ingresados por el usuario en tiempo de ejecución.

;Nombre : matriz_mul7.asm
;Proposito : ENCONTRAR EL PRIMER ELEMENTO M° 7 EN UNA MATRIZ
;Autor : David Fernando Prieto Cardoso y Luigiu Fernando. Valeriano Huacarpuma
;FCreacion : 04/07/2023
;FModific. : ---
;Compilar :
; nasm -f elf matriz_mul7.asm -Wall
; ld -m elf_i386 -s -o matriz_mul7 matriz_mul7.o io.o
; ./matriz_mul7
...
;Arreglar xd :V
section .data
    titulo db "APP PARA ENCONTRAR EL 1° ELEM. MUL. DE 7",10,0
    separarador db "========================================",10,0 
    ...
    separador2 db "------",10,0
    separador3 db "--------------------------------",10,0
    msgMul7 db "El primer elemento multiplo de 7 se encuentra en la ", 0
    msgFila db "Fila ",0
    msgFila1 db "Elemento ",0
    msgColumna db " y Columna ",0
    msgNoExiste db "No existe un elemento mul. 7 en la matriz",10,0
    puntos db " : ",0,10
    msjCambiar db "Cambiar Matrices (S/n): ",0,10
    msjMul7 db "Encontrar el primer elem. multipli de 7 (S/n): ",0,10
    tab db "",9,0
...
mostrar_menu:
    ...
    je mul7_matriz
        ;si es "SI"
            ;imprimir 2
            ;redireccionar a modulo mul7_elemento
    ;preguntar 7
mostrar_menu1:
    PutStr msjCambiar
    GetCh AL 
